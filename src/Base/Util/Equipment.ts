...
if (process && process.env && process.title != "node") {
    ...
    currentEnir = type == "Windows_NT" ? JSRUNEnvirType.NODE_WIN : (type == "Darwin" ? JSRUNEnvirType.NODE_MAC : JSRUNEnvirType.NODE_LINUX)
} else {
...
const isWeb = currentEnir == JSRUNEnvirType.WEB ||
...
const isNode = currentEnir == JSRUNEnvirType.NODE ||
